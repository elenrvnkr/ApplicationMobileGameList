...
On a aussi ajouté un bouton sur la liste  de jeux pour pouvoir voir uniquement les favoris.
On a aussi ajouté un bouton afin de revenir en haut de la page si on va trop bas.
